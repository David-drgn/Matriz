...
(default,'Liderança', 1, 100),
(default,'Trabalho em equipe', 1, 100),
(default,'Programação Web', 1, 100),
(default,'Banco de Dados', 1, 100),
(default,'Design', 1, 100),
(default,'Programação Mobile', 1, 100),
(default,'Redes', 1, 100),
(default,'Gestão de Projetos', 1, 100),
(default,'Ética', 1, 100),
(default,'RH', 1, 100),
(default,'Comunicação', 1, 100),
(default,'Marketing', 1, 100);
